...
export default function FinancePage() {
    ...
    const calculateLoan = () => {
        ...
        // 입력 검증
        if (!loanAmount.trim() || !loanRate.trim() || !loanYears.trim() ||
            isNaN(amountNum) || isNaN(rateNum) || isNaN(yearsNum) ||
            amountNum <= 0 || rateNum <= 0 || yearsNum <= 0) {
                    ...
                    {isLoanCategory && (
                        <div style={styles.sidebar}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                                ...
                                >
                                    <label style={{ whiteSpace: "nowrap", flex: "1 1 45%" }}>
                                        <input
                                            type="radio"
                                            name="repayType"
                                    ...
                                    >
                                        ...
                                        <div style={{ width: "100%", height: "180px", marginTop: "8px" }}>
                                            <ResponsiveContainer>
                                                <BarChart
                                                    data={[
                                                        { name: "원금", 금액: totalPayment - totalInterest },
                                                ...
                                                >
                                                    <XAxis dataKey="name" />
                                                    <YAxis
                                                        domain={[0, (dataMax) => Math.ceil(dataMax / 10000000) * 10000000 * 1.2]} // ✅ 20% 여유
                                                    ...
                                                    />
                                                    <Legend />
                                                    <Bar dataKey="금액" fill="#3b82f6" radius={[6, 6, 0, 0]} />
                                                </BarChart>
                                            </ResponsiveContainer>
                                        </div>
                                    </div>
